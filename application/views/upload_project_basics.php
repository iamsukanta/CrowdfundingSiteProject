...
<div id="upload_project_details">
    ...
    <div class="upload_project_details_inner">
        ...
        <form action="<?php echo base_url(); ?>project_uploader/save_project_basics" method="post" enctype="multipart/form-data">
            ...
            <div class="upload_project_details_inner_sidebar_right">
                ...
                <form>
                    ...
                    <textarea name="tagline" rows="4" cols="60"></textarea><br/>100/100 <br/>
                    ...
                    -->
                    <span id="card_image_upload_button">
...
<!--                    <span id="tag_form">-->
                    <input  id='tags_3' type="text" name="tags" class='tags' placeholder="Please give some tag to find contents" value=""/>
<!--                          <input id='tags_3' name="tags" type='text' class='tags'/>-->
                    <!--                    </span>-->
                    ...
                    <p id="basics_text_funding">Fundings ends <span id="days_limit">
                            <input type="text" name="deadline" placeholder="" value=""/></span>
                    </p>
